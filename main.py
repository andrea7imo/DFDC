...
training_set = Dataset('/aiml/project/DFDC/FramesDataset_full/train', transform=train_transform, max_real=None, max_fake=18663)
...
saveModel(best_epoch, best_model_wts, loss_values, accuracies, accuraciesTrain, F_1s,
          f'/aiml/project/DFDC/Outputs/models/model_all-18663-{NUM_EPOCHS}-fine_adam_best-trans.pth')
